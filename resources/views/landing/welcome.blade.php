                    ...
                    <div class="flex flex-col md:flex-row md:justify-between mb-5 gap-4">
                        <div class="flex flex-col">
                            ...
                            <p class="text-gray-400 text-xs">
                                Kumpulan data Komponen yang berada di Laboratorium
                            </p>
                        </div>
                ...
                <div class="col-span-12 lg:col-span-4 row-start-1">
                    <div class="md:shadow-custom md:bg-white md:rounded-lg md:border">
                        <div class="flex flex-col p-4">
                            ...
                            <p class="text-gray-400 text-xs">Kumpulan data kategori yang berada di Laboratorium</p>
                        </div>
                                ...
                                <a href="{{ route('category.show', $category->slug) }}"
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-500">
                                            {{ $category->products->count() }} Komponen
                                        </p>
                                    </div>
                                </a>
                            @endforeach
